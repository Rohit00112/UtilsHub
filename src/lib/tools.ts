...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    steps: ['Upload a PDF from your device.', 'Scroll the full document or jump between pages with thumbnails.', 'Choose text, highlight, whiteout, box, line, pen, or image mode from the toolbar.', 'Click or drag directly on a page, then adjust selected edits in the properties panel.', 'Export and download the edited PDF.'],
    useCases: ['Add approval text to a document', 'Cover a typo and place replacement text', 'Highlight a clause or section', 'Draw a box around an area for review', 'Add a signature image or pen note'],
    faqs: [
      ...
      { q: 'Can I scroll through the whole PDF?', a: 'Yes. The editor renders the document as stacked pages inside a scrollable workspace, with thumbnails for quick page jumps.' },
      { q: 'Do I need to enter coordinates?', a: 'No. The PDF is rendered as a document preview, and you place edits by clicking or dragging directly on any page.' },
      { q: 'Are my PDF files uploaded?', a: 'No. The PDF is read, edited, and saved entirely in your browser.' },
      { q: 'Can I add drawings and images?', a: 'Yes. Use pen or line mode for drawings, or image mode to place PNG and JPG images on a page.' },
      commonFaqPrivacy,
    ],
