...
export const categories: Category[] = [
  ...
  },
  {
    id: 'image',
    name: 'Image Tools',
    description: 'Crop, clean, convert, resize, and inspect images in your browser.',
    longDescription:
      'FreeWebTools image tools cover the common edits you need before publishing or sharing a picture: crop to exact dimensions, clean a small unwanted mark, remove EXIF metadata, pick colors, resize, convert to WebP, generate favicons, and merge several images into a single file. All of them use the browser\'s built-in Canvas API, so the work happens on your device and your images are never uploaded to a third-party service. That keeps personal photos and unreleased designs private, avoids upload queues, and gives you a downloadable result immediately. The tools are free, require no account, and run in any modern browser.',
    keywords: ['image tools', 'watermark remover', 'image cropper', 'EXIF remover', 'image color picker', 'WebP converter', 'image resizer'],
    faqs: [
      ...
      { q: 'Can I remove metadata before sharing a photo?', a: 'Yes. The metadata remover rebuilds the pixels into a new image without the original EXIF block, including embedded location and camera details.' },
...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    metaDescription: 'Remove a small watermark or unwanted mark from your own image locally. Select the area, clean it in your browser, and download a PNG.',
    slug: 'watermark-remover',
    categoryId: 'image',
    status: 'active',
    keywords: ['watermark remover', 'remove watermark from image', 'clean image watermark', 'remove unwanted mark', 'watermark remover no upload'],
    longDescription:
      'Watermark Remover cleans a selected rectangular area by rebuilding it from the pixels along its surrounding edges. Drag across the full mark with a little padding, run the cleanup, and download the edited result as a PNG. The method works best for small logos, timestamps, or text over a flat, blurred, sky, wall, or other simple background. Detailed textures, faces, and large marks may need a full photo editor with clone or generative-fill controls.\n\nThe complete image stays in your browser and is never uploaded. You can undo the last cleanup or reset to the original at any time. Use this tool only for images you own or have permission to edit; removing ownership or attribution marks from someone else\'s work may violate their rights.',
    steps: ['Upload an image you own or have permission to edit.', 'Drag across the entire watermark with a small margin.', 'Click remove selection and inspect the result.', 'Undo, adjust the selection, or download the cleaned PNG.'],
    useCases: ['Remove your old brand mark before applying a new one', 'Clean a camera timestamp from your own photo', 'Repair a small unwanted text label over a simple background'],
    faqs: [
      { q: 'Does it use AI?', a: 'No. It uses a fast local pixel interpolation method based on the edges around your selection. That keeps the image private and works well for small marks on simple backgrounds.' },
      { q: 'Why does a complex background look blurred?', a: 'The browser rebuilds the selected pixels from nearby colors but cannot reconstruct hidden detail. Use a clone or generative-fill editor for large marks over faces, patterns, or fine texture.' },
      { q: 'Can I remove any watermark?', a: 'Only remove marks from images you own or are authorized to edit. Watermarks often communicate ownership or licensing, and removing one without permission may infringe those rights.' },
      commonFaqPrivacy,
    ],
    related: ['image-cropper', 'metadata-remover', 'image-resizer'],
  },
  {
    id: 'image-cropper',
    name: 'Image Cropper',
    description: 'Crop an image to exact dimensions or a common aspect ratio.',
    metaDescription: 'Crop images online to exact pixels, square, 4:3, or 16:9. Export PNG, JPEG, or WebP locally without uploading your photo.',
    slug: 'cropper',
    categoryId: 'image',
    status: 'active',
    keywords: ['image cropper', 'crop image online', 'crop image to square', 'crop photo no upload', 'crop to 16:9'],
    longDescription:
      'Image Cropper removes unwanted edges and exports only the part of a picture you need. Start with the full image, choose a centered square, 4:3, or 16:9 crop, or enter exact X, Y, width, and height values for pixel-precise work. The preview shades everything outside the final frame so the output is clear before you download it.\n\nCropping and export happen with the browser Canvas API, so personal photos and unreleased designs stay on your device. Export as PNG for transparency and crisp graphics, JPEG for photographs, or WebP for a compact web-ready file.',
    steps: ['Upload an image.', 'Choose an aspect ratio or enter exact crop coordinates.', 'Pick PNG, JPEG, or WebP output.', 'Crop and download the result.'],
    useCases: ['Create a square profile picture', 'Crop a 16:9 video thumbnail', 'Remove empty borders from a screenshot', 'Export an exact region for a web layout'],
    faqs: [
      { q: 'Which aspect ratios are included?', a: 'Use a free crop or choose centered presets for square (1:1), 4:3, and widescreen 16:9 output.' },
      { q: 'Does cropping resize the image?', a: 'No. The selected pixels keep their original resolution. Use Image Resizer afterward if you also need different output dimensions.' },
      { q: 'Which output format should I choose?', a: 'Use PNG for transparency or sharp interface graphics, JPEG for photos, and WebP for smaller web images.' },
      commonFaqPrivacy,
    ],
    sources: [
      { label: 'MDN Canvas drawImage documentation', url: 'https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage' },
    ],
    related: ['image-resizer', 'webp-converter', 'watermark-remover'],
  },
  {
    id: 'metadata-remover',
    name: 'Image Metadata Remover',
    description: 'Strip EXIF, GPS, camera, and other embedded image metadata.',
    metaDescription: 'Remove EXIF and GPS metadata from images locally in your browser. Batch-clean photos and export JPEG, PNG, or WebP without uploads.',
    slug: 'metadata-remover',
    categoryId: 'image',
    status: 'active',
    keywords: ['image metadata remover', 'remove EXIF data', 'remove GPS from photo', 'strip photo metadata', 'EXIF remover no upload'],
    longDescription:
      'Image Metadata Remover creates a fresh image from the visible pixels, leaving the source file\'s metadata blocks behind. That strips EXIF fields commonly used for camera model, capture settings, dates, editing software, and—when a phone or camera stored it—GPS location. Batch processing lets you clean several photos before posting them publicly or sending them to someone else.\n\nThe source files stay in your browser. Choose JPEG, PNG, or WebP output and keep the original elsewhere if you may need its capture time, orientation, copyright, or location data later. Re-encoding can change file size and, for JPEG or WebP, applies the quality level you select.',
    steps: ['Choose one or more images.', 'Select an output format and quality.', 'Remove metadata to rebuild each image.', 'Download files individually or as a ZIP.'],
    useCases: ['Remove GPS coordinates before sharing phone photos', 'Clean camera details from images posted publicly', 'Batch-strip metadata from client deliverables'],
    faqs: [
      { q: 'Which metadata is removed?', a: 'Rebuilding through Canvas omits the original EXIF, IPTC, XMP, GPS, thumbnail, and application-specific metadata blocks. The output contains the rendered pixels and basic format data needed to display them.' },
      { q: 'Does this change the visible image?', a: 'PNG export is lossless. JPEG and WebP are re-encoded at your chosen quality, which can make a small visual or file-size difference.' },
      { q: 'Should I delete the original?', a: 'Keep it if capture dates, camera settings, orientation, copyright fields, or location data may be useful later. The cleaned download is a separate file.' },
      commonFaqPrivacy,
    ],
    related: ['image-resizer', 'webp-converter', 'image-color-picker'],
  },
  {
    id: 'image-color-picker',
    name: 'Image Color Picker',
    description: 'Pick exact pixel colors and extract a palette from an image.',
    metaDescription: 'Pick HEX and RGB colors from any image and extract a six-color palette locally in your browser. Free, private, and no upload required.',
    slug: 'color-picker',
    categoryId: 'image',
    status: 'active',
    keywords: ['image color picker', 'pick color from image', 'extract color palette', 'image to HEX', 'RGB color picker'],
    longDescription:
      'Image Color Picker reads the exact RGB value under your pointer and converts it to a copy-ready hexadecimal color. It also samples the image to build a compact palette of its most frequent color groups, which is useful when you need a starting point for a website, presentation, illustration, or brand mood board.\n\nAll sampling happens in your browser, so the image is never uploaded. Click any point for a precise pixel value, then copy its HEX or RGB form. Palette colors are intentionally grouped into nearby tones so a photograph produces a useful overview instead of hundreds of nearly identical values.',
    steps: ['Upload an image.', 'Click or tap any pixel to inspect it.', 'Copy the selected HEX or RGB value.', 'Use the extracted palette for a quick color overview.'],
    useCases: ['Match a color from a logo or screenshot', 'Build a palette from a reference photo', 'Inspect exact interface colors during implementation'],
    faqs: [
      { q: 'Why can the palette differ from a clicked pixel?', a: 'The palette groups nearby colors into broader buckets so it can show the dominant tones. Clicking the image returns the exact pixel value instead.' },
      { q: 'What is the difference between HEX and RGB?', a: 'They describe the same red, green, and blue channels in different notation. HEX is compact for CSS, while RGB is often easier to adjust channel by channel.' },
      { q: 'Does color management affect the result?', a: 'The picker reads the pixels after the browser decodes the image into its display color space. Specialized print workflows should use a color-managed desktop editor.' },
      commonFaqPrivacy,
    ],
