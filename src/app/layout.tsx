...
// Keep ads off navigation and interactive utility screens; only authored guides
// are publisher-content inventory.
const adPaths = getAllPosts().map((post) => `/blog/${post.slug}`);
