            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="bg-bg-secondary border-2 border-border rounded-lg p-4 flex flex-wrap gap-6 items-center justify-between">
                    <div className="flex items-center gap-4">
                        <span className="text-text-secondary font-medium">Compare by:</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-[400px]">
                    <div className="flex flex-col h-full">
                        <label className="text-lg font-semibold text-text-primary mb-3">Original Text</label>
                        <textarea
                    ...
                    <div className="flex flex-col h-full">
                        <label className="text-lg font-semibold text-text-primary mb-3">Modified Text</label>
                        <textarea
                            className="flex-1 w-full p-4 bg-bg-secondary border-2 border-border rounded-lg resize-none focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 font-mono text-sm leading-relaxed"
                ...
                {/* Output Section */}
                <div className="bg-bg-secondary border-2 border-border rounded-lg p-6 min-h-[200px]">
                    <h3 className="text-lg font-semibold text-text-primary mb-4">Differences</h3>
                    <div className="bg-bg-tertiary p-6 rounded-lg font-mono text-sm leading-relaxed whitespace-pre-wrap break-words border border-border">
                        {diffResult.length > 0 ? (
                            ...
                            <span className="text-text-tertiary italic">Result will appear here...</span>
                        )}
                    </div>
                </div>
            </div>
