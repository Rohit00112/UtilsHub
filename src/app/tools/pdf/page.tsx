...
const pdfTools = [
  {
    name: 'PDF Compare',
    description: 'Compare the text content of two PDF files side-by-side',
    href: '/tools/pdf/compare',
    icon: '📄',
  },
  // Add more PDF tools here in future
];
      ...
      <div className="bg-bg-secondary border-b border-border relative">
        ...
        <div className="container py-12 relative z-10">
          ...
          <p className="text-xl text-text-secondary m-0">
            Process, transform, and analyze PDF files
          </p>
        </div>
      </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="border-2 border-dashed border-border rounded-lg p-8 flex flex-col items-center justify-center text-center opacity-75 hover:opacity-100 transition-opacity">
              ...
              <p className="text-text-secondary">We are working on Merger, Splitter, and more!</p>
            </div>
          </div>
        </div>
      </main>
