      ...
      <main className="py-16">
        <div className="container">
          <div className="text-center p-16 bg-bg-secondary border-2 border-border rounded-2xl max-w-2xl mx-auto">
            ...
            <p className="text-text-secondary mb-6 text-lg">Web tools are under development:</p>
            <ul className="list-none p-0 text-text-secondary space-y-2">
              <li className="before:content-['✓'] before:text-primary before:font-bold before:mr-2">URL Shortener</li>
              <li className="before:content-['✓'] before:text-primary before:font-bold before:mr-2">Open Graph Preview</li>
              <li className="before:content-['✓'] before:text-primary before:font-bold before:mr-2">HTTP Header Checker</li>
              <li className="before:content-['✓'] before:text-primary before:font-bold before:mr-2">DNS Lookup</li>
              <li className="before:content-['✓'] before:text-primary before:font-bold before:mr-2">WHOIS Lookup</li>
            </ul>
          </div>
        </div>
      </main>
